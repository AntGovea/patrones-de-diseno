...
class InventoryReport implements Report {
  ...
  generate(): void {
    ...
    console.log('%cGenerando reporte de Inventario...', COLORS.gray)
  }
}

class ShoppingReport implements Report {
  generate(): void {
    console.log('%cGenerando reporte de Compras...', COLORS.orange)
...
class ShoppingReportFactory extends ReportFactory {
  override createReport(): Report {
...
function main() {
  ...
  const reportType = prompt(
    '¿Qué tipo de reporte deseas?(sales/inventory/shoppings)',
    COLORS.red
  );
console.log('reportType',reportType)
  if (reportType === 'sales') {
    reportFactory = new SalesReportFactory();
  } else if (reportType === 'shoppings') {
    reportFactory = new ShoppingReportFactory();
  }
  else {
